...
local bearlib = {
    Themes = {
        QuangHuy = {
            ...
            ["Color Hub 2"] = Color3.fromRGB(15,10,30),
            ["Color Stroke"] = Color3.fromRGB(0,0,0),
            ["Color Theme"] = Color3.fromRGB(120,50,200),
            ["Color Text"] = Color3.fromRGB(200, 180, 255),
            ["Color Dark Text"] = Color3.fromRGB(200, 180, 255),
            ["Color Discord Text"] = Color3.fromRGB(200, 180, 255),
            ["Color Discord Stats"] = Color3.fromRGB(120, 50, 200),
            ["Color Discord Border"] = Color3.fromRGB(120, 50, 200),
            ["Color Profile Border"] = Color3.fromRGB(120, 50,200),
            ["Color Card Border"] = Color3.fromRGB(120, 50, 200),
            ["Color Toggle On"] = Color3.fromRGB(120, 50, 200),
            ["Color Toggle Off"] = Color3.fromRGB(25, 15, 50),
            ["Color Toggle Knob On"] = Color3.fromRGB(25, 15, 50),
            ["Color Toggle Knob Off"] = Color3.fromRGB(120, 50, 200),
            ["Color Toggle Border"] = Color3.fromRGB(200, 180, 255),
            ["Border Thickness"] = 1.5,
            ["UI Border Color"] = Color3.fromRGB(200,180,255),
        }
    },
    Info = {
        Version = "1.0"
...
local SetProps, SetChildren, InsertTheme, Create do
    ...
    pcall(Save, "the_real_Panda library v1.json")
end
...
task.spawn(function()
    task.wait(2)
    bearlib:Notify({
        Title = "the_real_Panda Library",
        Message = "UI Library Download Completed",
        Duration = 10
    })
end)
